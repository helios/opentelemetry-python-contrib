...
from opentelemetry.instrumentation.kafka.utils import _wrap_send, _wrap_next, HookT, dummy_callback
...
class KafkaInstrumentor(BaseInstrumentor):
    ...
    def _instrument(self, **kwargs):
        ...
        wrap_function_wrapper("kafka", "KafkaConsumer.__next__", _wrap_next(tracer, consume_hook))
