...
class TestUtils(TestCase):
    ...
    def test_wrap_send(
        ...
        inject.assert_called_once_with(
            headers, context=context, setter=_kafka_setter
        )
    ...
    def test_wrap_next(
        ...
        record = wrapped_next(
            original_next_callback, kafka_consumer, args, kwargs
        )
